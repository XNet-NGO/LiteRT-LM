...
class RepetitionPenaltyProcessorParamTest
    : public ::testing::TestWithParam<ProcessLogitsFloatVariant> {
 protected:
...
INSTANTIATE_TEST_SUITE_P(
    ProcessLogitsVariant, RepetitionPenaltyProcessorParamTest,
    ::testing::Values(ProcessLogitsFloatVariant::kSpanFloat,
                      ProcessLogitsFloatVariant::kSpanHalf));

class RepetitionPenaltyProcessorInvalidDimsTest
    : public ::testing::TestWithParam<std::tuple<
          ProcessLogitsFloatVariant, std::vector<::litert::Layout::Dim>>> {};
